...
basemaps = {
        ...
        'GoogleSatelliteHybrid': folium.TileLayer(
        ...
        'EsriSatellite': folium.TileLayer(
...
class addbasemaps:
    ...
    def googleMap(self):
        basemaps['GoogleMaps'].add_to(self.my_map)

    def GoogleSatellite(self):
        basemaps['GoogleSatellite'].add_to(self.my_map)
    
    
    def GoogleTerrain(self):
        basemaps['GoogleTerrain'].add_to(self.my_map)
        
    def GoogleSatelliteHybrid(self):
        basemaps['GoogleSatelliteHybrid'].add_to(self.my_map)
    
    def EsriSatellite(self):
        basemaps['EsriSatellite'].add_to(self.my_map)
